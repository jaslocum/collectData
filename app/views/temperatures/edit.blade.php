...
<div class='row clearfix'>
    ...
    {{Form::open(array('route'=>array('temperatures.update',$temperature->id), 'method'=>'PUT'))}}
        <div class="col-sm-12">
            <h2><span class="glyphicon glyphicon-edit"></span>Edit Temperature</h2>
        </div>
        <div class="col-sm-4">
            <div class='form-group'>
                {{ Form::label('id', 'Id') }}
                {{ Form::text('id', $temperature->id, array('class'=>'form-control', 'readonly'=>'readonly')) }}
            </div>
            <div class='form-group'>
                {{Form::label('record_id', 'Record') }}
                {{Form::text('record_id',$temperature->record->name,array('class'=>'form-control', 'readonly'=>'readonly'))}}
            </div>
            <div class='form-group'>
            ...
            <div class='form-group'>
                ...
                {{ Form::text('created_at', $temperature->created_at, array('class'=>'form-control', 'readonly'=>'readonly')) }}
            </div>
            <div class='form-group'>
                {{ Form::label('updated_at', 'Updated') }}
                {{ Form::text('updated_at', $temperature->updated_at, array('class'=>'form-control', 'readonly'=>'readonly')) }}
            </div>
            <div class = "col-sm-12">
